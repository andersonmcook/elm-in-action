...
var $author$project$PhotoGroove$getPhotos = $elm$http$Http$get(
	{
		expect: A2(
...
var $author$project$PhotoGroove$initialModel = {activity: '', chosenSize: $author$project$PhotoGroove$Large, hue: 0, noise: 0, ripple: 0, status: $author$project$PhotoGroove$Loading};
var $author$project$PhotoGroove$init = function (pastaVersion) {
	return _Utils_Tuple2(
		_Utils_update(
			$author$project$PhotoGroove$initialModel,
			{
				activity: 'Initializing Pasta v' + $elm$core$String$fromFloat(pastaVersion)
			}),
		$author$project$PhotoGroove$getPhotos);
};
...
var $author$project$PhotoGroove$viewLoaded = F3(
	function (photos, selectedUrl, _v0) {
		var activity = _v0.activity;
		var chosenSize = _v0.chosenSize;
		var hue = _v0.hue;
		var noise = _v0.noise;
		var ripple = _v0.ripple;
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$h1,
				...
				_List_fromArray(
					[
						A3($author$project$PhotoGroove$viewFilter, $author$project$PhotoGroove$SlidHue, 'Hue', hue),
						A3($author$project$PhotoGroove$viewFilter, $author$project$PhotoGroove$SlidRipple, 'Ripple', ripple),
						A3($author$project$PhotoGroove$viewFilter, $author$project$PhotoGroove$SlidNoise, 'Noise', noise)
					])),
				A2(
				$elm$html$Html$h3,
				_List_Nil,
