		...
		switch (msg.$) {
			...
			case 'GotPhotos':
				if (msg.a.$ === 'Ok') {
					...
					var _n3 = A2(elm$core$String$split, ',', response);
					if (_n3.b) {
						var urls = _n3;
						var firstUrl = urls.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									status: A2(
										...
										A2(elm$core$List$map, author$project$PhotoGroove$Photo, urls),
										firstUrl)
								}),
							elm$core$Platform$Cmd$none);
					} else {
...
var author$project$PhotoGroove$view = function (_n0) {
	var chosenSize = _n0.chosenSize;
	...
	return A2(
		...
		function () {
			switch (status.$) {
				case 'Loaded':
					var photos = status.a;
					var selectedUrl = status.b;
					return A3(author$project$PhotoGroove$viewLoaded, photos, selectedUrl, chosenSize);
				case 'Loading':
					return _List_Nil;
				default:
...
var author$project$PhotoGroove$main = elm$browser$Browser$element(
	{
		init: elm$core$Basics$always(
			_Utils_Tuple2(author$project$PhotoGroove$initialModel, elm$core$Platform$Cmd$none)),
