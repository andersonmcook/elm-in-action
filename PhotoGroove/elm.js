...
var $author$project$PhotoGroove$initialModel = {chosenSize: $author$project$PhotoGroove$Large, hue: 0, noise: 0, ripple: 0, status: $author$project$PhotoGroove$Loading};
...
var $author$project$PhotoGroove$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2($author$project$PhotoGroove$initialModel, $author$project$PhotoGroove$getPhotos)),
